...
## هرس آلفا-بتا
هرس آلفا-بتا، که راهی برای بهینه سازی مینی ماکس است، برخی از محاسبات بازگشتی ای را که به طور قطع نامطلوب هستند،
نادیده می گیرد. پس از تعیین مقدار یک عمل، اگر در همان ابتدا شواهدی وجود داشته باشد که نشان دهد این عمل، در
مقایسه با عملی که قبلاً مشخص شده، می تواند حریف را به امتیاز بهتری برساند، نیازی نیست که این عمل بیشتر از این
بررسی شود زیرا، در مقایسه با مورد قبلی، قطعاً مطلوبیت کمتری خواهد داشت.
این موضوع را می توان به راحتی با یک مثال نشان داد: بازیکن بیشینه ساز می داند که در مرحلۀ بعدی، بازیکن کمینه ساز سعی
خواهد کرد پایین ترین امتیاز را به دست آورد. فرض کنید بازیکن بیشینه ساز، سه عمل امکان پذیر دارد و مقدار عمل اول 4
است. سپس، این بازیکن شروع به تولید مقدار برای عمل بعدی می کند. بدین منظور، وی مقادیر متناظر با اعمال بازیکن
کمینه ساز را تولید می کند، به شرط آ نکه بازیکن فعلی این عمل را انتخاب کرده باشد. این کار با علم به این نکته انجام
میشود که بازیکن کمینه ساز عملی را انتخاب خواهد کرد که پایین ترین امتیاز را داشته باشد. اما قبل از تمام کردن محاسبات
برای همه ی عمل های ممکنِ کمینه ساز، بازیکن متوجه می شود که یکی از گزینه ها دارای مقدار 3 است. این بدین معناست
که هیچ دلیلی برای ادامه دادن به اکتشاف سایر عمل های ممکن برای بازیکن کمینه ساز، وجود ندار د. مقدار عملی که هنوز
ارزش گذاری نشده است، مهم نیست، چه 10 باشد چه 10-. اگر مقدار 10 باشد، کمینه ساز کمترین گزینه، یعنی 3 را که از
مقدار 4 قبلی بدتر است، انتخاب خواهد کرد. اگر عملی که هنوز ارز شگذاری نشده 10- از کار درآید، کمینه ساز، این گزینه
یعنی 10- را که برای بیشینه ساز نامطلوب تر است، انتخاب خواهد کرد. بنابراین، محاسبۀ سایر عمل های محتمل برای
کمینه ساز در این نقطه، برای بیشینه ساز بی معناست زیرا بازیکن بیشینه ساز از قبل مقدار 4 را دارد که یقیناً گزینۀ بهتری است.


## مینی ماکس با عمق محدود
مجموعاً 55,1682 بازی محتمل برای دوز و 29000^10 بازی محتمل برای شطرنج وجود دارد. همان طور که تاکنون نشان داده
شده است، الگوریتم مینی ماکس نیاز دارد که تمامی بازی های فرضی را از نقطه ای خاص تا شرایط نهایی تولید کند. اگرچه
محاسبۀ تمامی بازی های دوز برای یک کامپیوتر مدرن امری چالش برانگیز نیست اما انجام این کار برای شطرنج فعلاً
امکان پذیر نیست.
مینی ماکس با عمق محدود، بدون اینکه هیچ گاه به حالت نهایی برود، تنها تعداد مشخصی از حرکات را بررسی می کند و
سپس متوقف می شود. البته این کار امکان به دست آوردن مقدار دقیق هر عمل را فراهم نمی آورد زیرا به انتهای بازیهای
فرضی نرسیده است. برای رفع این مشکل، مینی ماکس با عمق محدود به یک تابع ارزیابی متکی است؛ این تابع، امید ریاضی
مطلوبیت بازی را در یک حالت مشخص تخمین  می زند، یا به عبارت دیگر، به هر حالت یک مقدار اختصاص می دهد. برای
مثال، در بازی شطرنج، تابع مطلوبیت، پیکربندی فعلی تخته را به عنوان ورودی می گیرد و سعی میکند مطلوبیت مورد انتظار
آن را (بر اساس مهره هایی که هر بازیکن دارد و موقعیت آ نها روی تخته) ارزیابی کند. سپس، مقداری مثبت یا منفی به دست
می دهد که میزان مطلوبیت تخته برای یک بازیکن، در برابر بازیکن دیگر، را نشان می دهد. از این مقادیر می توان برای
تصمیم گیری دربارۀ عمل صحیح استفاده کرد. هر چه تابع ارزیابی بهتر باشد، الگوریتم مینی ماکسی که به آن متکی است بهتر
خواهد بود.
